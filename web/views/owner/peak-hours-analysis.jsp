...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .page-sub   { color: #a0714f; font-size: 0.95rem; margin: 4px 0 0; }
        ...
        .filter-bar input:focus { outline: none; border-color: #76493b; }
        ...
        .badge-low    { background: #e4edff; color: #2456a6; }
    ...
    <script>
        ...
        if (hourLabels.length > 0) {
            ...
            const barColors = hourData.map(v => {
                const r = v / maxVal;
                if (r >= 0.85) return 'rgba(227, 73, 72, 0.8)';
                if (r >= 0.60) return 'rgba(237, 161, 0, 0.8)';
