...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        input { padding:9px 12px; border:1px solid #d7bfa4; border-radius:7px; font-family:inherit; font-size:0.9rem; }
        .btn { padding:7px 12px; border-radius:7px; border:none; cursor:pointer; font-size:0.82rem; font-weight:600; text-decoration:none; display:inline-flex; gap:5px; align-items:center; }
        .btn-checkin  { background:#198754; color:#fff; }
        .btn-checkout { background:#0d6efd; color:#fff; }
        ...
        td { padding:11px; border-bottom:1px solid #f5ece4; font-size:0.9rem; color:#4a3528; vertical-align:middle; }
        ...
        .readonly-tag { color:#8a6e5a; font-style:italic; font-size:0.82rem; }
    </style>
</head>
<body>
