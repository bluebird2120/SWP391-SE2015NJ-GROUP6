        ...
        <head>
            ...
            <style>
                ...
                table {
                    ...
                    border-radius: 10px;
                    overflow: hidden;
                    /* Khi bo vẫn còn đường kẻ cái này để làm mất */
                    border: none;
                }
                        ...
                        <div style="flex:1; padding:32px; background:#f8f9fa; min-width:0;">
                            <div class="layout">
                                <div class="page-header">
                                    ...
                                    <input class="btn-create" type="button" value="THÊM MỚI LOẠI MÓN ĂN"
                                        onclick="openCreateModal()" /><br />
                                </div>
                                <c:if test="${errorName != null && !errorName.trim().isEmpty()}">
                                ...
                                <table border="1">
                                    ...
                                    <c:forEach var="cat" items="${categoryList}">
                                        <tr>
                                            ...
                                            <td>
                                                <div>${cat.totalDish}</div>
                                            </td>
                                            <td>
                                                <div>${cat.activeMenuItem}</div>
                                            </td>
                                            <td>
                                                <div>${cat.inactiveMenuItem}</div>
                                            </td>
                                            <td>
                                                <input class="btn-table btn-edit" type="button" value="SỬA TÊN"
                                                    onclick="openEditModal('${cat.categoryID}', '${cat.categoryName}')" />
                                                <input class="btn-table btn-disable" type="button"
                                                    value="VÔ HIỆU HÓA" />
                                            </td>
                                        </tr>
                                    </c:forEach>
                ...
                <div id="editModal" class="modal-wrapper">
                    <div class="modal-box">
                        ...
                        <form action="category-management" method="post">
                            ...
                            <input type="text" id="modalCategoryName" name="categoryName" /><br />
