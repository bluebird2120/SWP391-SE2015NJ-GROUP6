...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        h2 { margin: 28px 0 12px; color: #5d3a2e; font-size: 1.15rem; }
        .sub { margin: 0 0 20px; color: #8a6e5a; }
        .message { padding: 12px 14px; border-radius: 8px; margin-bottom: 16px; background: #fff2cc; }
        .summary-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(230px, 1fr)); gap: 12px; }
        .summary-card, .panel { background: white; border: 1px solid #eaded6; border-radius: 12px; padding: 16px; }
        .summary-card h3 { margin: 0 0 12px; color: #76493b; font-size: 1rem; }
        .counts { display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px; font-size: .88rem; }
        .count { background: #f8f2ed; padding: 8px; border-radius: 7px; }
        table { width: 100%; border-collapse: collapse; }
        th, td { padding: 11px 9px; text-align: left; border-bottom: 1px solid #eee2da; vertical-align: middle; }
        th { color: #76493b; background: #fbf7f3; }
        .badge { display: inline-block; padding: 4px 9px; border-radius: 999px; font-size: .78rem; font-weight: bold; }
        .available { background: #dff5e5; color: #176b36; }
        .reserved { background: #e4edff; color: #2456a6; }
        .serving { background: #fff0cc; color: #8a5700; }
        .cleaning { background: #f5e2ff; color: #71368a; }
        select { padding: 8px; border: 1px solid #d8c6ba; border-radius: 7px; min-width: 170px; }
        button { border: 0; border-radius: 7px; padding: 9px 12px; background: #76493b; color: white; cursor: pointer; }
        button.clean { background: #176b55; }
        .empty { color: #927b6d; padding: 18px 4px; }
