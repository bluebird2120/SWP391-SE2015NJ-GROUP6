...
<html lang="vi">
    <head>
        ...
        <title>Đổi mật khẩu – Vị An Restaurant</title>
        ...
        <div class="page-body">
            <div class="login-box">
                ...
                <div class="left">
                    ...
                    <h2 class="welcome-text">Đổi mật khẩu</h2>
                ...
                <div class="right">
                    ...
                    <c:if test="${not empty forceReason}">
                        <div class="error-box">
                            <i class="fas fa-circle-exclamation"></i> ${forceReason}
                        </div>
                    </c:if>
                    ...
                    <form id="changePasswordForm"
                        ...
                        <div class="field">
                            ...
                            <input type="password"
                                   ...
                                   class="${not empty oldPasswordError ? 'input-error' : ''}"
                                   required>
